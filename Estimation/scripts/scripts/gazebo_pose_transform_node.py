...
class GazeboPoseTransformNode(object):
    ...
    def __init__(self):
        ...
        # A相对于B的位姿（由/tag_detections 计算得到）
        ...
        # 订阅 AprilTag 检测结果，获取 C 相对 D 的位姿
        self.sub_tag_detections = rospy.Subscriber('/tag_detections', AprilTagDetectionArray, self.tag_detections_cb, queue_size=1)
    ...
    def tag_detections_cb(self, msg):
        """订阅 /tag_detections，计算并发布 A 相对于 B 的位姿"""
